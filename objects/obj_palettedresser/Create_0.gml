...
for (var i = 0; i < array_length(player_palettes); i++)
{
	...
	array_push(player_palettes[i], ["z", true, 12, spr_peppattern16]);
	array_push(player_palettes[i], ["squid", true, 12, spr_peppattern17]);
	array_push(player_palettes[i], ["messy", true, 12, spr_peppattern18]);
